    ...
    <SidebarInset>
      <header className="flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
        <div className="flex items-center gap-2 px-4">
          ...
          <h1 className="text-lg font-semibold">Gerenciamento de Grupos</h1>
        </div>
      </header>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {grupos.reduce((acc, grupo) => acc + grupo.membros, 0)}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Distribuídos em {grupos.length} grupos
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    R$ {grupos.reduce((acc, grupo) => acc + grupo.metaMensal, 0).toLocaleString()}
                  </div>
                  <p className="text-xs text-muted-foreground">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {calcularPerformance(
                      grupos.reduce((acc, grupo) => acc + grupo.vendidoMes, 0),
                      grupos.reduce((acc, grupo) => acc + grupo.metaMensal, 0),
                    )}
                    %
                  </div>
